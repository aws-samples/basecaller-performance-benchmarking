...
def main():
    ...
    aws_batch_env.create_batch_jobs(
        compute, container=BASECALLER_DORADO_0_3_0, cmd=dorado_no_modified_bases,
        tags='dorado v0.3.0, no modified bases')
    aws_batch_env.create_batch_jobs(
        compute, container=BASECALLER_DORADO_0_5_3, cmd=dorado_no_modified_bases,
        tags='dorado v0.5.3, no modified bases')
    aws_batch_env.create_batch_jobs(
        compute, container=BASECALLER_DORADO_0_3_0, cmd=dorado_modified_bases_5mCG,
        tags='dorado v0.3.0, modified bases 5mCG')
    aws_batch_env.create_batch_jobs(
        compute, container=BASECALLER_DORADO_0_5_3, cmd=dorado_modified_bases_5mCG,
        tags='dorado v0.5.3, modified bases 5mCG')
    aws_batch_env.create_batch_jobs(
        compute, container=BASECALLER_DORADO_0_3_0, cmd=dorado_modified_bases_5mCG_5hmCG,
        tags='dorado v0.3.0, modified bases 5mCG & 5hmCG')
    aws_batch_env.create_batch_jobs(
        compute, container=BASECALLER_DORADO_0_5_3, cmd=dorado_modified_bases_5mCG_5hmCG,
